...
func indexTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.tmpl", size: 4198, mode: os.FileMode(436), modTime: time.Unix(1523285727, 0)}
...
func nodeTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "node.tmpl", size: 1021, mode: os.FileMode(436), modTime: time.Unix(1523285727, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
