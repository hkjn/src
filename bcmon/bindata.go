...
func bcmonTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "bcmon.tmpl", size: 719, mode: os.FileMode(436), modTime: time.Unix(1518713145, 0)}
