...
func indexTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.tmpl", size: 4198, mode: os.FileMode(420), modTime: time.Unix(1521133991, 0)}
