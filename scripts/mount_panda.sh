...
[[ -e /dev/mapper/panda ]] || {
	sudo cryptsetup luksOpen --key-file=/root/keys/usb-WD_ELEMENTS_SE_25FF_etc-part1.key /dev/disk/by-id/usb-WD_Elements_SE_25FF_5758333144343835535A304A-0\:0-part1 panda
}
